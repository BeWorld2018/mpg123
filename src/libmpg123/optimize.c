...
#endif
#if defined(OPT_ALTIVEC) && defined(__MORPHOS__)
	else if(HasAltiVec && basic_synth == INT123_synth_1to1_altivec) type = altivec;
#endif
#ifdef OPT_X86_64
...
#endif
#if defined(OPT_ALTIVEC) && defined(__MORPHOS__)
	else if(HasAltiVec && basic_synth == INT123_synth_1to1_real_altivec) type = altivec;
#endif
#ifdef OPT_NEON
...
#endif
#if defined(OPT_ALTIVEC) && defined(__MORPHOS__)
	else if(HasAltiVec && basic_synth == INT123_synth_1to1_s32_altivec) type = altivec;
#endif
#ifdef OPT_NEON
